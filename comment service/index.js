...
(arr[2] ? arr[2][0].toUpperCase() + arr[2].slice(1).toLowerCase() : '');// замена первой буквы на заглавную
    ...
    if(link === ''){
        ...
        randomImage[0]= "/comment service/assets/img/alex.png";
        randomImage[1]= "/comment service/assets/img/biene.png";
        randomImage[2]= "/comment service/assets/img/cat.png";
        randomImage[3]= "/comment service/assets/img/pony.png";
        randomImage[4]= "/comment service/assets/img/Simpson.png";
        randomImage[5]= "/comment service/assets/img/smile.png";
    ...
    displayChat.style.borderBottom = "2px dashed rgba(20, 39, 189, 0.822)";
